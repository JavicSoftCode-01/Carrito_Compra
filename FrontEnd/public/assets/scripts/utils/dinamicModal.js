    ...
    return `
      <form id="category-form" class="dynamic-form">
        ...
        <div class="form-group">
          ...
          <input type="text" id="category-description" name="descripcion" class="form-input" 
                 value="${isEdit ? category.description : ''}"
                 pattern="^[a-zA-ZÀ-ÿ\\s]{3,50}$"
      ...
      <form id="supplier-form" class="dynamic-form">
        ...
        <div class="form-group">
          ...
          <input type="tel" id="supplier-phone" name="telefono" class="form-input"
                 ...
                 placeholder="Ingresar número fijo o celular"
                 autocomplete="off"
        ...
        <div class="form-group">
          ...
          <input type="email" id="supplier-email" name="correo" class="form-input"
                 ...
                 autocomplete="off"
                 title="Ingrese un correo válido, por ejemplo: usuario@example.com" />
        </div>
        
        <div class="form-group">
          <label for="supplier-address" class="form-label">Dirección:</label>
          <input type="text" id="supplier-address" name="direccion" class="form-input" 
                 value="${isEdit ? supplier.address : ''}"
                 pattern="^.{3,100}$"
                 placeholder="Ingresar dirección"
                 autocomplete="off" required
                 title="Ingrese entre 3 y 100 caracteres" />
        </div>
    ...
    return `
      <form id="product-form" class="dynamic-form">
        ...
        <div class="form-group">
          ...
          <input type="number" id="product-price" name="precio" class="form-input" 
                 ...
                 placeholder="0.00"
                 autocomplete="off"
                 title="Ingrese un precio válido mayor a 0" />
        </div>
        ...
        <div class="form-group">
          ...
          <input type="number" id="product-quantity" name="cantidad" class="form-input" 
                 min="1" 
                 value="${isEdit ? product.quantity : ''}" required
                 placeholder="Cantidad"
                 autocomplete="off"
                 title="Ingrese una cantidad mínima de 1" />
        </div>
        ...
        <div class="form-group">
          ...
          <input type="number" id="product-stock" name="stock" class="form-input" 
                 ...
                 min="0"
                 step="1"
                 title="Ingrese un número entero positivo para el stock" />
        </div>
        ` : ''}
        ...
        <div class="form-group">
          ...
          <input type="number" id="product-pvp" name="precio_venta" class="form-input" 
                 step="0.01" min="0.01" 
                 value="${isEdit ? product.pvp : ''}" required
                 placeholder="0.00"
                 autocomplete="off"
                 title="Ingrese un precio válido mayor a 0" />
        </div>
      ...
      `<option value="${supplier.id}" ${isEdit && product.supplierId === supplier.id ? 'selected' : ''}>
        ...
        <div class="form-group">
          ...
          <input type="text" id="product-description" name="descripcion" class="form-input" 
                 value="${isEdit ? product.description : ''}"
                 pattern="^[a-zA-Z0-9À-ÿ\\s,.!?]{3,100}$"
                 placeholder="Descripción del producto"
                 autocomplete="off" required
                 title="Ingrese entre 3 y 100 caracteres, solo letras, números, espacios y puntuación básica" />
        </div>
        ...
        <div class="form-group">
          ...
          <input type="url" id="product-imgLink" name="imgLink" class="form-input" 
                 ...
                 autocomplete="off"
                 title="Ingrese una URL de imagen válida" />
        </div>
